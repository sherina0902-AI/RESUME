...
<head>
  ...
  <title>Резюме — Щербич Ирина Ильгизовна</title>
  ...
  <style>
    :root {
      ...
      --shadow: 0 20px 45px rgba(23, 32, 51, 0.10);
      --radius: 24px;
    }
    ...
    * {
    ...
    h1 {
      ...
      margin-bottom: 20px;
      background: linear-gradient(90deg, #172033, #2563eb, #7c3aed, #06b6d4);
    ...
    .focus {
      ...
      color: #fff;
      background:
        linear-gradient(135deg, rgba(23,32,51,0.96), rgba(37,99,235,0.92)),
